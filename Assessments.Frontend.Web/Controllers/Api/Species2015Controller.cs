...
namespace Assessments.Frontend.Web.Controllers.Api
{
    ...
    public class Species2015Controller : BaseController<Species2015Controller>
    {
        ...
        public async Task<IActionResult> Get() => Ok(await DataRepository.GetData<Rodliste2015>(Helpers.Constants.Species2015));
        ...
        {
            var data = await DataRepository.GetData<Rodliste2015>(Helpers.Constants.Species2015);
