...
namespace Assessments.Frontend.Web.Infrastructure
{
    public static class Constants
    {
        ...
        public const string riskMatrixFigureText = "Når en fremmed art risikovurderes, vurderes både artens invasjonspotensial og artens negative økologiske effekter i norsk natur. Vurderingen resulterer dermed i to skår, én for artens invasjonspotensial (1 – 4) og én for artens økologiske effekter (1 – 4). Kombinasjonen av disse to skårene gir artens plassering i risikomatrisen og bestemmer risikokategori (NK: ingen kjent risiko, LO: lav risiko, PH: potensielt høy risiko, HI: høy risiko, SE: svært høy risiko). Tallet i en celle viser antall vurderinger i utvalget med gitte kombinasjon av økologisk effekt og invasjonspotensial.";
